...
export const api = {
  ...
  sorteo: {
    ...
    premiosEspecial: () => request('/sorteo/premios-especial'),
    historialEspecial: () => request('/sorteo/historial-especial'),
    oportunidadesEspecial: () => request('/sorteo/oportunidades-especial'),
    girarEspecial: () => request('/sorteo/girar-especial', { method: 'POST' }),
  },
  admin: {
    ...
    premiosRuletaEspecial: () => request('/admin/premios-ruleta-especial'),
    actualizarPremiosRuletaEspecial: (data) => request('/admin/premios-ruleta-especial', { method: 'PUT', body: JSON.stringify(data) }),
