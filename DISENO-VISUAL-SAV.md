# SAV — Documento de Diseño Visual
...
### Marca
- **Nombre:** SAV (reemplazar cualquier "SVA" en referencias)
- **Logo:** Icono con diamante/cuadrado estilizado de color azul
- **Variantes:** Texto "SAV" en blanco o negro según fondo
...
- Overlay central con logo SAV (hexagonal)
